          ...
          {filteredRecipes.map((recipe) => (
            ...
            >
              ...
              <div className="grid grid-cols-1 grid-rows-1 mb-6 z-10">
                <motion.div layoutId={`tags-${recipe.id}`} className="col-start-1 row-start-1 flex flex-wrap items-start content-start gap-2 transition-all duration-300 group-hover:opacity-0 group-hover:-translate-y-2">
                  {recipe.tags.map(tag => (
                ...
                {/* Hover Macros */}
                <div className="col-start-1 row-start-1 flex flex-wrap items-start content-start gap-2 opacity-0 translate-y-2 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none">
                  {recipe.macros ? (
