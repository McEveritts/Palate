...
export default async function VaultPage() {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-8 md:p-16 relative bg-slate-950">
      {/* Specular glows */}
      ...
      <div className="max-w-[2400px] mx-auto relative z-10">
        <header className="mb-8 sm:mb-12">
          <h1 className="text-3xl sm:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 via-white to-fuchsia-300 drop-shadow-[0_0_15px_rgba(255,255,255,0.3)] mb-3 sm:mb-4">
            Recipe Vault
          </h1>
          <p className="text-indigo-200/70 text-sm sm:text-lg max-w-2xl font-medium">
