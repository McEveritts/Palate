...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={inter.variable} suppressHydrationWarning>
      <body className="flex flex-col lg:flex-row h-[100dvh] w-screen overflow-hidden bg-slate-950 text-white" suppressHydrationWarning>
        <AuthProvider>
          ...
          <main className="flex-1 z-10 p-0 overflow-y-auto relative flex flex-col min-h-0">
            {children}
          </main>
        </AuthProvider>
      </body>
