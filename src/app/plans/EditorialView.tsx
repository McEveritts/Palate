    ...
    <div className="w-full relative">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <motion.div
          ...
          className="md:col-span-2 min-h-[400px] cursor-pointer group relative overflow-hidden rounded-3xl bg-slate-900/40 border border-white/10 backdrop-blur-2xl p-8 md:p-12 flex flex-col justify-end shadow-2xl transition-all duration-500 hover:shadow-[0_0_40px_rgba(139,92,246,0.2)]"
        >
          ...
          <motion.h3 layoutId={`title-${heroRecipe.id}`} className="text-4xl md:text-6xl font-extrabold text-white mb-4 z-10 relative leading-tight tracking-tight drop-shadow-md">
            {heroRecipe.title}
          </motion.h3>
